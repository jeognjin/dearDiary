...
<section class="notice">
  <div class="page-title">
    ...
    <form name="boardForm" method="post" action="${contextPath }/board/modify.do?boardNo=${board.boardNo}" enctype="multipart/form-data">
<div class="wrap">
	<div id="tip-title-box">
	   <input id="tip-title" name="title" value="${board.title }">
	</div>
	...
	<div class="tip-title-box">
	 <textarea class="editor-contents" name="content">${board.content }</textarea>
 </div>
...
<div id="fileUpload">
     ...
     <div id="btn-box">
        <div id="btn-box-center">
            ...
            <div id="submit-btn" ><button type="submit" class="btn_right btn_dark_right">수정완료</button></div>
        </div>
    </div>
    </div>
  </form>
