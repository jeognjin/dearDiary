...
<form action="${contextPath }/member/delete.do" method="post" class="joinForm">
      ...
      <p style="color: brown; font-size: 14px;">회원 탈퇴 시, 작성한 일기가 삭제 됩니다.</p>
      <input type="submit" class="btn" value="Withdrawal"/>
    </form>
